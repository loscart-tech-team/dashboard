          ...
          <div className="flex flex-col justify-center">
            ...
            >
              ...
              <p className="flex items-center ">
                <input
                  className="mr-2 mt-[3px] flex checked:bg-purple-600 w-[20px] h-[20px]"
                  type="checkbox"
                />{" "}
                Beni hatırla
              </p>
              <button
                type="submit"
                className="border rounded-lg w-full my-5 py-2 bg-indigo-600 hover:bg-indigo-500 text-white"
              >
                Giriş Yap
              </button>
              <div className="pl-[60px] flex ">
                <p className="">Sorun mu Yaşıyorsun? </p>
                <NavLink to="/" className="text-blue-600 pl-1 ">
                  {" "}
                  İletişime geç
                </NavLink>
              </div>
